...
const productsData = [
  { nameAr: "سمك ديرك", price: 5000, available: true, category: "fish" as const, displayOrder: 1 },
  { nameAr: "سمك جحش", price: 2500, available: true, category: "fish" as const, displayOrder: 2 },
  { nameAr: "سمك فارس", price: 2500, available: true, category: "fish" as const, displayOrder: 3 },
  { nameAr: "سمك سلمون", price: 3500, available: true, category: "fish" as const, displayOrder: 4 },
  { nameAr: "سمك مرجان", price: 3500, available: true, category: "fish" as const, displayOrder: 5 },
  { nameAr: "سمك هامور", price: 3500, available: true, category: "fish" as const, displayOrder: 6 },
  { nameAr: "سمك غنا", price: 0, available: false, category: "fish" as const, displayOrder: 7 },
  { nameAr: "سمك حفار", price: 0, available: false, category: "fish" as const, displayOrder: 8 },
  { nameAr: "سمك قرض", price: 3000, available: true, category: "fish" as const, displayOrder: 9 },
  { nameAr: "سمك صولفيش", price: 2500, available: true, category: "fish" as const, displayOrder: 10 },
  { nameAr: "سمك ببغاء", price: 2500, available: true, category: "fish" as const, displayOrder: 11 },
  { nameAr: "سمك سخله", price: 3000, available: true, category: "fish" as const, displayOrder: 12 },
  { nameAr: "سمك عربي", price: 2500, available: true, category: "fish" as const, displayOrder: 13 },
  { nameAr: "سمك قد", price: 2000, available: true, category: "fish" as const, displayOrder: 14 },
  { nameAr: "سمك قد أصفر", price: 0, available: false, category: "fish" as const, displayOrder: 15 },
  { nameAr: "سمك حمام", price: 2500, available: true, category: "fish" as const, displayOrder: 16 },
  { nameAr: "سمك دجاج", price: 0, available: false, category: "fish" as const, displayOrder: 17 },
  { nameAr: "سمك ولد", price: 2000, available: true, category: "fish" as const, displayOrder: 18 },
  { nameAr: "سمك بهار", price: 0, available: false, category: "fish" as const, displayOrder: 19 },
  { nameAr: "سمك سمان", price: 0, available: false, category: "fish" as const, displayOrder: 20 },
  { nameAr: "سمك ظبي", price: 2500, available: true, category: "fish" as const, displayOrder: 21 },
  { nameAr: "سمك عنتق", price: 2500, available: true, category: "fish" as const, displayOrder: 22 },
  { nameAr: "سمك هداس", price: 0, available: false, category: "fish" as const, displayOrder: 23 },
  { nameAr: "سمك سلطان", price: 2500, available: true, category: "fish" as const, displayOrder: 24 },
  { nameAr: "سمك بياض", price: 2000, available: true, category: "fish" as const, displayOrder: 25 },
  { nameAr: "سمك ضمكري", price: 2500, available: true, category: "fish" as const, displayOrder: 26 },
  { nameAr: "سمك ابوعين", price: 3000, available: true, category: "fish" as const, displayOrder: 27 },
  { nameAr: "سمك بكاس", price: 0, available: false, category: "fish" as const, displayOrder: 28 },
  { nameAr: "سمك جلاعف", price: 0, available: false, category: "fish" as const, displayOrder: 29 },
  { nameAr: "سمك منقم", price: 0, available: false, category: "fish" as const, displayOrder: 30 },
  { nameAr: "سمك ناقم", price: 0, available: false, category: "fish" as const, displayOrder: 31 },
  { nameAr: "سمك بعرور", price: 2500, available: true, category: "fish" as const, displayOrder: 32 },
  { nameAr: "سمك حدر", price: 0, available: false, category: "fish" as const, displayOrder: 33 },
  { nameAr: "سمك جرم", price: 2500, available: true, category: "fish" as const, displayOrder: 34 },
  { nameAr: "سمك لسن", price: 2000, available: true, category: "fish" as const, displayOrder: 35 },
  { nameAr: "سمك عنفلوص", price: 0, available: false, category: "fish" as const, displayOrder: 36 },
  { nameAr: "سمك باغه", price: 1000, available: true, category: "fish" as const, displayOrder: 37 },
  { nameAr: "جمبري كبير", price: 5000, available: true, category: "seafood" as const, displayOrder: 38 },
  { nameAr: "جمبري مخلوط", price: 4000, available: true, category: "seafood" as const, displayOrder: 39 },
  { nameAr: "جمبري صغير (حميره)", price: 2500, available: true, category: "seafood" as const, displayOrder: 40 },
  { nameAr: "شروخ", price: 5000, available: true, category: "seafood" as const, displayOrder: 41 },
  { nameAr: "حبار كبير", price: 0, available: false, category: "seafood" as const, displayOrder: 42 },
  { nameAr: "حبار صغير", price: 0, available: false, category: "seafood" as const, displayOrder: 43 },
  { nameAr: "ابو مقص", price: 1500, available: true, category: "seafood" as const, displayOrder: 44 },
];
